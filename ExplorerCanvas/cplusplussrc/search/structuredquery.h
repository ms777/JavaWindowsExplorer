/*
 * https://github.com/eddieringle/portaudio/blob/master/src/hostapi/wasapi/mingw-include/structuredquery.h
 */
...
typedef/* [v1_enum] */
	...
	SQMO_VIRTUAL_PROPERTY = 0, SQMO_DEFAULT_PROPERTY = (SQMO_VIRTUAL_PROPERTY
			+ 1), SQMO_GENERATOR_FOR_TYPE = (SQMO_DEFAULT_PROPERTY + 1)
...
enum tagQUERY_PARSER_MANAGER_OPTION {
	...
	QPMO_UNLOCALIZED_SCHEMA_BINARY_PATH = (QPMO_PRELOCALIZED_SCHEMA_BINARY_PATH
			+ 1),
...
/* [unique][uuid][object] */EXTERN_C const IID IID_IQueryParser;
...
public:
	...
	/* [in] */__RPC__in_opt ICondition *pCondition, /* [in] */BOOL fUseEnglish,
...
/* [unique][uuid][object] */EXTERN_C const IID IID_IConditionFactory;
#if defined(__cplusplus) && !defined(CINTERFACE)
...
public:
	...
	/* [in] */__RPC__in_opt ICondition *pSubCondition, /* [in] */BOOL simplify,
	...
	/* [in] */__RPC__in_opt IRichChunk *pValueTerm, /* [in] */BOOL expand,
	/* [retval][out] */__RPC__deref_out_opt ICondition **ppResultQuery) = 0;
	virtual /* [local] */ HRESULT STDMETHODCALLTYPE Resolve(
	/* [in] */	ICondition *pConditionTree,
	/* [in] */ STRUCTURED_QUERY_RESOLVE_OPTION sqro,
	/* [ref][in] */	const SYSTEMTIME *pstReferenceTime,
	/* [retval][out] */	ICondition **ppResolvedConditionTree) = 0;
};
#else /* C style interface */
...
/* [unique][uuid][object] */EXTERN_C const IID IID_IQuerySolution;
#if defined(__cplusplus) && !defined(CINTERFACE)
...
//	virtual HRESULT STDMETHODCALLTYPE GetErrors(/* [in] */__RPC__in REFIID riid,
...
//ms777
	virtual HRESULT STDMETHODCALLTYPE GetQuery(
			...
			IEntity **ppMainType) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetErrors(__RPC__in REFIID riid,	__RPC__deref_out_opt void **ppParseErrors) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetLexicalData(
			LPWSTR *ppszInputString,
			ITokenCollection **ppTokens,
			LCID *pLocale,
			IUnknown **ppWordBreaker) = 0;
};
#else /* C style interface */
...
{
public:
	virtual HRESULT STDMETHODCALLTYPE GetConditionType(/* [retval][out] */ __RPC__out CONDITION_TYPE *pNodeType) = 0;
